...
#define BM_LP_GPIO_WAKE                    0      /* 0=BLE娣辩潯鍙暀RTC鍞ら啋(绋冲畾,榛樿); 1=鍚敤鎸夐敭GPIO鍞ら啋(鍙兘鑷碆LE娣辩潯澶嶄綅) */
#endif
#ifndef BM_LP_STOP_ADV
#define BM_LP_STOP_ADV                     1      /* 1=寰呮満娣辩潯鏃跺仠姝㈠箍鎾?闄嶄负uA绾?涓嶅彲鍙戠幇); 0=淇濇寔骞挎挱(鍙彂鐜颁絾鐢垫祦杈冮珮) */
#endif
 ...
 * BLE/RF mode: legacy HAL/ui.c). Switching fixes from B0.3/B0.4 are kept: TMR3 scans
 * only in USB mode, BLE_MODE uses get_key, boot-hold-7 forces USB. */
