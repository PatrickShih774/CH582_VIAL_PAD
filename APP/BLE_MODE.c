...
//    tmos_start_task(hidEmuTaskId, WS2812_EVENT, MS1_TO_SYSTEM_TIME(80));
}
...
static void hidEmuSendKbdReport(uint8_t *keycode)
{
    ...
    buf[4] = keycode[2];       // Keycode 3
    buf[5] = keycode[3];       // Keycode 4
    buf[6] = keycode[4];       // Keycode 5
    buf[7] = keycode[5];       // Keycode 6
