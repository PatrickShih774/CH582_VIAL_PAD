 ...
 */
    uint8_t key_mode = 0;
    //vial֧�ֳ�ʼ���ͱ�Դ����У�飬������鲻ͨ���޷���������
    //���ɾ��У������̲�֧��vial����ȡ����Ҳ��ʧ��
    // vial_init() �ڿ� flash ��У��ʧ�ܻ���ѭ����У�� 0x3E00/0x7F018�����ʳ��ײ�������
    // �ֶ��� vial_key_done=1 ʹ���� vial ���д�������ã�ģʽֱ�Ӵ� EEPROM ����
    extern uint8_t vial_key_done;
    vial_key_done = 1;
    {
        uint8_t mode;
        EEPROM_READ(0x3F00, &mode, 1);    // ֱ��Ӳ�������� flash ���� 0xFF
